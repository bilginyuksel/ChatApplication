...
public class ChatGroupAdapter extends ArrayAdapter<Message> {
    ...
    private class ViewHolder{
        TextView txtMessage,txtMessageTime,txtSender;
        LinearLayout linearLayout;

    }


    public ChatGroupAdapter(Context context,List<Message> messageList) {
        super(context, 0);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(m!= null){
            ...
            if(m.getSender().getUID().equals(HomePage.currentUser.getUID())){
                ...
                convertView = inflater.inflate(R.layout.card_group_their_message,null);
                ...
                viewholder.txtMessage.setText(m.getMessage());
                viewholder.txtMessageTime.setText(format.format(m.getMessage_date()));
                viewholder.txtSender.setText("~ "+m.getSender().getName()+" "+m.getSender().getSurname());
                convertView.setTag(viewholder);
