...
public class LoginPage extends Activity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String email = sharedPreferences.getString("Email","dpuyzt@gmail.com");
        String password = sharedPreferences.getString("Password","000000");


        if(!email.equals("dpuyzt@gmail.com")){
            Intent i = new Intent(LoginPage.this,SplashScreen.class);
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if(task.isSuccessful()){
                        mAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if(task.isSuccessful()){
                                    User u = new User(mAuth.getCurrentUser().getUid(),"hakki dincer","sogur",
                                            email,s,"profilephoto");
                                    new FirebaseUser().addData(u,u.getUID());
                                }
                            }
                        });
                    }
            ...
            mAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if(task.isSuccessful()){
                        ...
                        editor.putString("Email",email); //int değer kayıt eklemek için kullanıyoruz.
                        editor.putString("Password",password); //string değer kayıt etmek için kullanıyoruz.
                        editor.commit();
